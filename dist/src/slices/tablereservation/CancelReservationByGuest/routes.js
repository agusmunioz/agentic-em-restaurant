...
const api = () => (router) => {
     ...
     */
    router.post('/api/cancelreservationbyguest/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        ...
        try {
            ...
            const result = yield (0, CancelReservationByGuestCommand_1.handleCancelReservationByGuest)(command);
            if (correlationId)
